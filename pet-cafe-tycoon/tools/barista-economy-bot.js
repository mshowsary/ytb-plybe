...
function runScenario({ name, baristaAware }) {
  ...
  function ownerStep(dt) {
    ...
    switch (target.kind) {
      ...
      // Arriving somewhere that needs empty hands IS the action: the live game flies the load home
      // the moment the owner stops there (systems/stations.js flyBackHeld).
