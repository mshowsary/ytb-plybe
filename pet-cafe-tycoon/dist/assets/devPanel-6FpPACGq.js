import{a as e,rt as t}from"./three-cbuf-PSy.js";import{a as n,c as r,d as i,f as a,g as o,h as s,i as c,l,m as u,n as d,o as f,p,r as m,s as h,t as g,u as _}from"./index-7tYswFUf.js";var v=[[1,400],[3,650],[5,950],[8,1400],[10,1600],[12,1900],[14,2200],[16,3e3],[20,3800],[24,4400],[28,5e3],[32,6200],[36,7e3],[40,7500]];function y(e){let t=Math.max(1,e|0),n=v[v.length-1];if(t<=v[0][0])return v[0][1];if(t>=n[0])return n[1];for(let e=0;e<v.length-1;e++){let[n,r]=v[e],[i,a]=v[e+1];if(t>=n&&t<=i)return Math.round(r+(a-r)*(t-n)/(i-n))}return n[1]}var b=30,x=`
