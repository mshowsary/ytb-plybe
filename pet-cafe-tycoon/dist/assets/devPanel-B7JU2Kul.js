import{a as e,rt as t}from"./three-cbuf-PSy.js";import{a as n,c as r,i,l as a,n as o,o as s,r as c,s as l,t as u,u as d}from"./index-NEnEG9e-.js";var f=[[1,400],[3,650],[5,950],[8,1400],[10,1600],[12,1900],[14,2200],[16,3e3],[20,3800],[24,4400],[28,5e3],[32,6200],[36,7e3],[40,7500]];function p(e){let t=Math.max(1,e|0),n=f[f.length-1];if(t<=f[0][0])return f[0][1];if(t>=n[0])return n[1];for(let e=0;e<f.length-1;e++){let[n,r]=f[e],[i,a]=f[e+1];if(t>=n&&t<=i)return Math.round(r+(a-r)*(t-n)/(i-n))}return n[1]}var m=30,h=`
