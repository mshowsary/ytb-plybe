...
import * as LAYOUT from '../game/layout.js';
const LOC_EMOJI = () => LAYOUT.LOC.emoji;
...
export function createUpgrades(root, W, audio, fx, onPause) {
  ...
  document.body.insertAdjacentHTML('beforeend', `
    <div class="sheet hidden" id="upsheet"><div class="sheet-card">
      <div class="sheet-head"><b id="uptitle">⬆ Upgrades</b><span class="upcoins"><i class="coin"></i><b id="upcoins">0</b></span><button class="close" aria-label="Close">✕</button></div>
  ...
  function render() {
    ...
    document.getElementById('uptitle').textContent = `⬆ ${LOC_EMOJI()} Upgrades`;
